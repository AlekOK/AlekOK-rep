...
##############################################################
# n = int(input("enter  how must be numbers of the list: "))
# a = [input("enter your value") for f in range(n) ]
# print(a)
######################################
# a = [input("enter your value") for f in range(int(input("enter  how must be numbers of the list: "))) ]
# print(a)
####################################################################################
# # 1. create list and print max and min elements
# a = [input("enter your value") for f in range(int(input("enter  how must be numbers of the list: "))) ]
# g = max(a)
# w = min(a)
# print("Max number is = {} and min number is = {}".format(g , w))
#####################################################################################
# 2.1 print even numbers from 1 to 11
#  odd_numbers = [x for x in range(1,11) if x % 2 == 0]
# print(odd_numbers)
#######################################
# 2.2 print odd numbers that are divided into 3
#  even_numbers = [x for x in range(1,11) if x % 2 ==1 and  x % 3  ==0 ]
# print(even_numbers)
######################################
# #2.3 print numbers that aren't divided into 2 and 3
